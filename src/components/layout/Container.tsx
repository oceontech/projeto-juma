...
export function Container({
  ...
  return (
    <Tag className={`mx-auto w-full max-w-[84rem] lg:max-w-[85rem] 2xl:max-w-[84rem] min-[1600px]:max-w-[100rem] min-[2000px]:max-w-[120rem] px-md sm:px-lg lg:px-[2rem] xl:px-[3rem] 2xl:px-[6rem] min-[2000px]:px-md ${className}`}>
      {children}
    </Tag>
  )
}
