...
import { FlagBR, FlagES, FlagUS, type FlagComp } from '@/components/icons/flags'

/**
 * Seletor de idioma com bandeiras (SVG em components/icons/flags). Trigger
 * mostra a bandeira do idioma atual e abre um dropdown com os três idiomas
 * (bandeira + nome nativo). Abertura animada com GSAP (o painel cresce do
 * canto do gatilho e os itens entram em cascata). Substitui os acrônimos
 * do ADR-009.
 */
