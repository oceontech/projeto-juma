        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start relative">
          ...
          <div className="flex flex-col py-4 lg:col-start-1 lg:row-start-1">
            ...
            <div ref={ctaRef} className="mt-10 lg:mt-12">
              <Link
                href="/contato"
                className="btn-type inline-flex items-center justify-center rounded-full bg-primary px-xl py-md text-white transition-opacity hover:opacity-80"
              >
                {t('cta')}
              </Link>
            </div>
          ...
          <div ref={stepsRef} className="relative pl-[60px] mt-8 lg:contents">
            ...
            {([1, 2, 3] as const).map((n) => {
              ...
              >
                ...
                {/* Conteúdo do Passo: no desktop preenche toda a largura da
                    sua coluna na grid (cruzando de lado da linha — bem mais
                    largo que antes). No mobile usa uma proporção mais alta
                    em telas bem estreitas, alargando a partir do sm. */}
                <div className="relative w-full aspect-[4/5] sm:aspect-[4/3] lg:aspect-auto lg:h-[70vh] lg:min-h-[460px] xl:h-[75vh] flex">
