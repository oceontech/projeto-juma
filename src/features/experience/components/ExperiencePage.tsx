    ...
    <Container>
      <div ref={containerRef}>
        ...
        <div className="mb-24">
          ...
          <p ref={introRef} className="text-lg md:text-xl text-foreground/70 max-w-[64rem] leading-relaxed mb-8">
            {t('intro')}
          </p>
      ...
      <div ref={galleryRef} className="mb-32">
        ...
        {/* Bento Grid de imagens reais e tematizadas da Juma Experience */}
